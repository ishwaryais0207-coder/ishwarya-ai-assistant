...
# Page configuration
st.set_page_config(
    page_title="Chat with {YOUR_NAME}",
    page_icon="🤖",
    layout="centered",
...
\n".join(retrieved)
    ...
    system_prompt = (
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about {YOUR_NAME}. "
        ...
        f"Answer in third person when talking about {YOUR_NAME}, but you may use natural conversational language "
